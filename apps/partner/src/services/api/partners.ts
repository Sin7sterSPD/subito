...
export const partnersApi = {
  ...
  getMyBookings: () =>
    apiClient.get<PartnerBookingListItem[]>("/partners/me/bookings"),

  setAvailability: (availability: Exclude<AvailabilityStatus, "busy">) =>
    apiClient.put<{ updated: boolean; availabilityStatus: AvailabilityStatus }>(
  ...
  updateStatus: (
    partnerId: string,
    data: { status: PartnerBookingAction; bookingId: string }
  ) =>
    apiClient.put<{ updated: boolean; status: string }>(
